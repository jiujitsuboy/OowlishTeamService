...
import static com.oowlish.rolesapi.Constants.API_URL_PREFIX;
import static com.oowlish.rolesapi.Constants.AUTHORITY_PREFIX;
import static com.oowlish.rolesapi.Constants.H2_URL_PREFIX;
import static com.oowlish.rolesapi.Constants.REFRESH_URL;
import static com.oowlish.rolesapi.Constants.ROLE_CLAIM;
import static com.oowlish.rolesapi.Constants.SIGNUP_URL;
import static com.oowlish.rolesapi.Constants.SWAGGER_2_DOCS_URL;
import static com.oowlish.rolesapi.Constants.SWAGGER_2_UI_URL;
import static com.oowlish.rolesapi.Constants.TOKEN_URL;
    ...
    http.httpBasic().disable().formLogin().disable()
        ...
        .authorizeRequests()
         .antMatchers("/v2/api-docs",
             ...
             "/swagger-ui.html",
             "/webjars/**").permitAll()
//        .antMatchers(HttpMethod.GET, API_URL_PREFIX).permitAll()
//        .antMatchers(HttpMethod.POST, API_URL_PREFIX).permitAll()
//        .antMatchers(HttpMethod.PATCH, API_URL_PREFIX).permitAll()
